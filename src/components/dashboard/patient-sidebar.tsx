...
const patientNavigation = [
  ...
  { name: "Buscar Médicos", href: "/dashboard/patient/doctors", icon: Search },
  { name: "Agendar Consulta", href: "/dashboard/patient/schedule", icon: Calendar },
  { name: "Minhas Consultas", href: "/dashboard/patient/consultations", icon: Clock },
  { name: "Histórico Médico", href: "/dashboard/patient/medical-history", icon: History },
  { name: "Documentos", href: "/dashboard/patient/documents", icon: FileText },
  { name: "Loja", href: "/dashboard/patient/shop", icon: ShoppingBag },
  { name: "Atendimento", href: "/dashboard/patient/support", icon: MessageSquare },
  { name: "Configurações", href: "/dashboard/patient/settings", icon: Settings },
];
...
export function PatientSidebar({ isOpen = true, onClose }: PatientSidebarProps) {
    ...
    <>
      ...
      >
        ...
        <div className="lg:hidden flex items-center justify-between px-4 h-16 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-blue-600">MediConnect</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {patientNavigation.map((item) => {
          // Para Dashboard/Início, verificar apenas rota exata
